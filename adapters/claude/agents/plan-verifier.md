...
> **Invoke via `Agent({subagent_type: "aegis:plan-verifier"})`.** This is an agent, not a skill.
...
Read the template at `${CLAUDE_PLUGIN_ROOT}/templates/json/plan-audit-report/default.json` and follow its structure exactly.
