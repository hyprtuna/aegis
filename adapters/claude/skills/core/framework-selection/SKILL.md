...
> **Invoke via `Skill({skill: "aegis:framework-selection"})`.** This is a skill, not an agent. If you reached for the Agent tool, you're using the wrong primitive.
...
Read the template at `${CLAUDE_PLUGIN_ROOT}/templates/markdown/decisions/default.md` and follow its structure exactly.
