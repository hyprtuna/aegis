...
**Announce:** I'm using the `implementation-planner` skill's `decomposition.md` ability to break this goal into a sequenced, actionable plan an agent can execute.
