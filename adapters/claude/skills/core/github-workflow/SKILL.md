...
> **Invoke via `Skill({skill: "aegis:github-workflow"})`.** This is a skill, not an agent. If you reached for the Agent tool, you're using the wrong primitive.
