...
For the full label table, the exact JSON block schema, and copy-paste `gh` recipes, see `github-coordination/lock-convention.md`.
...
Exact `gh` recipes in `github-coordination/lock-convention.md`.
