...
**Announce:** I'm using the `orchestrate` skill's `background-results.md` ability to merge parallel agent outputs, deduplicate findings, and emit a synthesized summary.
