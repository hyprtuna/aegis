...
| **SessionStart hook**<br/><sub>session-start-hook</sub> | ✅ supported<br/>`.claude-plugin/plugin.json:99` | 🟡 partial<br/>`adapters/opencode/projection.md#approach-locked-decisions` | ⛔ gap<br/>`adapters/codex/projection.md#hook-capability-matrix` | ⛔ gap<br/>`adapters/cursor/projection.md#what-cursor-will-load` | ⛔ gap<br/>`adapters/zed/projection.md#unsupported-documented-gaps` |
