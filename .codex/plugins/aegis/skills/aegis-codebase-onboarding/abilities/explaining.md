...
**Announce:** I'm using the `codebase-onboarding` skill's `explaining.md` ability to explain this concept using codebase references and a concrete mental model.
...
Follow the structure in the bundled template `templates/markdown/concept-explainer/default.md` (shipped with this plugin).
