...
`abilities/io-and-prompts.md`. This body carries the ordering, the two gates, and the decision forks.
...
wording in `abilities/io-and-prompts.md`.

## Setup — ask before reviewing

1. Resolve the report **location** (Q1) and **format** (Q2). See `abilities/io-and-prompts.md` for
...
Use the Stage 1 dispatch prompt in `abilities/io-and-prompts.md`.
...
Use the Stage 2 dispatch prompt in `abilities/io-and-prompts.md`.
...
- **Called from an executor agent?** → pass task name, acceptance criteria, and changed files; block
  on any FAIL. See the executor-prompt snippet in `abilities/io-and-prompts.md`.
