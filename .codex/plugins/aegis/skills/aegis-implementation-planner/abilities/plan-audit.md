...
**Announce:** I'm using the `implementation-planner` skill's `plan-audit.md` ability to verify an implementation plan against its stated goal using goal-backward analysis.
...
[`plan-audit/validation-map-schema.md`](./plan-audit/validation-map-schema.md) for the
...
[`plan-audit/retroactive-validator.md`](./plan-audit/retroactive-validator.md).
...
When the report format is Structured JSON, also load `plan-audit/validation-map-schema.md` to
