...
the red-flags and checklist tables), see `spec-first/cycle-detail.md`. This body carries the gate,
...
Each phase's required outputs and gate mechanics live in `spec-first/cycle-detail.md`.
