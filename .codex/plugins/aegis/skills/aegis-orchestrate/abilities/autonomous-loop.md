...
**Announce:** I'm using the `orchestrate` skill's `autonomous-loop.md` ability for autonomous multi-step execution — planning, executing, verifying, and self-correcting.
