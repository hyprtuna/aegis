...
Follow the structure in the bundled template `templates/json/design-system/default.json` (shipped with this plugin).
...
## Inputs from sibling fragments

The industry-preset matrix below draws on:

- [`style-families.md`](./style-families.md) for the named visual style.
- [`color.md`](./color.md) for the role-based palette.
- [`typography.md`](./typography.md) for display/body pairings.

Read those three first for bespoke systems; use the built-in industry presets below as a fallback.
