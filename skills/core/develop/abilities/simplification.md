...
reducers, dead code, premature abstraction, naming), and load `simplification/slop-removal.md` when the
code smells machine-written.

### Intensity: ultra
Deepen beyond `full`: always run the `simplification/slop-removal.md` pass, trace cross-file dead code
