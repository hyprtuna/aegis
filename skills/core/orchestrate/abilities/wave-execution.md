...
**Announce:** I'm using the `orchestrate` skill's `wave-execution.md` ability to decompose this goal into parallel waves and synthesize the results.

You decompose complex goals into subtasks and dispatch them in parallel waves. This is the concise operational reference; see `when-to-fan-out.md` for deep guidance on prompting patterns and failure analysis.
